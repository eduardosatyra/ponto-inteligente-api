...
import com.satyra.pi.api.dtos.CadastroPJDto;
...
import com.satyra.pi.api.utils.PasswordUtils;
...
public class CadastroPJController {
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		if (result.hasErrors()) {
			...
			result.getAllErrors().forEach(error -> response.getErrors().add(error.getDefaultMessage())); //forEach java 8 >
