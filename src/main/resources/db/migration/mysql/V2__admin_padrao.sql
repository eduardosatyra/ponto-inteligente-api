...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'EFFS DEV');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@effs.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
